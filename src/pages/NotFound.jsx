  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center px-6 text-center relative overflow-hidden">
      ...
      >
        ...
        {/* big 404 */}
        <h1 className="text-[150px] md:text-[250px] font-black tracking-tighter leading-none animate-glitch opacity-20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 select-none pointer-events-none text-white">
        ...
        <div className="relative">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-gray-500 max-w-md text-sm leading-relaxed">
              ...
              The requested page does not exist inside the NHubX infrastructure.
              Please return to the main control hub.
