...
const Home = () => {
  ...
  return (
    <div className="relative h-screen flex flex-col justify-between overflow-hidden select-none">
      ...
      {/* Background Neon Glow Mesh with slow breathing animation */}
      <motion.div 
        animate={{ 
          scale: [1, 1.05, 1],
      ...
      {/* Decorative Floating Glass Sheet on the Right - Slow Floating & Rotating */}
      <motion.div 
      ...
      {/* Decorative Floating Glass Circle on the Left - Slow Vertical Drift */}
      <motion.div 
      ...
      <div className="flex-grow flex flex-col items-center justify-center px-4 sm:px-6 text-center mt-12">
        ...
        >
          ...
          >
            One Hub. <span className="text-white font-semibold">Infinite Power.</span>
          </motion.p>
          ...
          >
            <Link to="/projects">
              <Button variant="primary" className="px-7 py-3 text-xs tracking-wider rounded-lg">
                Explore Projects
              </Button>
            </Link>
            <Button variant="secondary" className="px-7 py-3 text-xs tracking-wider border-white/20 text-white rounded-lg bg-transparent hover:bg-white/5">
              View Docs
            </Button>
          </motion.div>
        </motion.div>
